...
Creating ucupaint node in the shader editor will create a node has only one channel, which is 'Color', you can connect the output of this channel to whatever node you want. You can create more channel later, it's explained in [channel page](../01.01.channel/).
