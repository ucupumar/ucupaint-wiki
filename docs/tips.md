...
- If you still want many generated textures, it's better to bake them as an image since the material performance will be a lot faster. The option to `Bake Mask as Image` is inside the gear button beside the mask.
