...
| Feature | Status | Comments |
|---------|---------|-----------|
| Bake layer as images for any layer types | Not started yet | Currently the system only works for layer types that have a source node with only one socket output. |
| Map any image channel into ucupaint layer channel | Not started yet | Useful to use ORM image as layer. |
...
| Feature | Status | Comments |
|---------|---------|-----------|
| Custom node group as layer/mask | Not started yet |  |
...
| Feature | Status | Comments |
|---------|---------|-----------|
| Any attributes data support | Not started yet | Currently ucupaint can only use color attributes. |
| Multiple decals in a single layer/mask | Not started yet |  |
| Vector/Coordinate warp | Testing | Manipulating vector mapping using images/attributes/generated textures |
| Multi-material batch baking | Not started yet |  |
| Baking multiple maps at the same time (AO, Pointiness, etc) | Not started yet |  |
| Multi-user node group support | Not started yet |  |
| Lock layers | Not started yet |  |
| Passthrough Group | Not started yet |  |
...
| Reimplement parallax | Not started yet |  |
